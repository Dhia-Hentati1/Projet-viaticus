          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header">
                <h4 class="card-title"> Trie des reservations selon le nombre de nuits</h4>
              </div>
              <div class="card-body">
...
$sql="SELECT IdH, dateAL, dateAR, nbN, nbC, nbP, nomH FROM rgeneral ORDER By nbN";
 ...
 { 
     ...
     { ?>
                        ...
                        <tr>
                         ...
                         <td><?php echo $row['dateAL']; ?></td>
                         <td><?php echo $row['dateAR']; ?></td>
                         <td><?php echo $row['nbN']; ?></td>
