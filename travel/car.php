						...
						<div class="row">
							...
							<div class="desc2 animate-box">
								<div class="col-sm-7 col-sm-push-1 col-md-7 col-md-push-1">
									...
									<h3>Fly to Hong Kong via california, USA</h3>
					...
					<div class="col-md-6 animate-box">
						<div class="car">
							<div class="one-4">
								...
								<span class="price"><?php echo $row ['description'];?><small></small></span>
								
							</div>
							<div class="one-1" style="background-image">
							<img src="../back/assets/img/<?php echo $row ['image'];?>" class="card-img-top" alt="" width="300" height="244">
							</div>
						</div>
					</div>
					<?php
