		...
		<div id="fh5co-tours" class="fh5co-section-gray" >
			<div class="container" >
				<div class="row">
					<div class="col-md-8 col-md-offset-2 text-center heading-section animate-box">
						...
						<p>Vous trouvez ici toutes les détails concernant ce vol </p>
					</div>
				</div>
			<?PHP
			...
			<div class="row">
				...
				<div class="col-md-6 animate-box" >
					<img class="img-responsive" src="../back/assets/img/compagnie.jpg" alt="travel">
						<a href="#" class="flight-book">
							<div class="plane-name">
								<span class="p-flight">Compagnie</span>
							</div>
							<div class="desc">
								<div class="left">									
						...
						<a href="#" class="flight-book">
							<div class="plane-name">
								<span class="p-flight">Email</span>
							</div>
							<div class="desc">
								<div class="left">									
						...
						<a href="#" class="flight-book">
							<div class="plane-name">
								<span class="p-flight">Date départ :</span>
							</div>
							<div class="desc">
								<div class="left">									
									<span><?PHP echo $user['date_depart']; ?></span>
								</div>								
							</div>
						</a>
						<a href="#" class="flight-book">
							<div class="plane-name">
								<span class="p-flight">Date arrivée :</span>
							</div>
							<div class="desc">
								<div class="left">									
									<span><?PHP echo $user['date_arrivee']; ?></span>
								</div>								
							</div>
						</a>
						<a href="#" class="flight-book">
							<div class="plane-name">
								<span class="p-flight">De :</span>
							</div>
							<div class="desc">
								<div class="left">									
									<span><?PHP echo $user['ville_depart']; ?></span>
								</div>								
							</div>
						</a>
						<a href="#" class="flight-book">
							<div class="plane-name">
								<span class="p-flight">A :</span>
							</div>
							<div class="desc">
								<div class="left">									
						...
						<a href="#" class="flight-book">
							<div class="plane-name">
								<span class="p-flight">Heure de départ :</span>
							</div>
							<div class="desc">
								<div class="left">									
									<span><?PHP echo $user['heure_depart']; ?></span>
								</div>								
							</div>
						</a>
						<a href="#" class="flight-book">
							<div class="plane-name">
								<span class="p-flight">Heure d'arrivée :</span>
							</div>
							<div class="desc">
								<div class="left">									
									<span><?PHP echo $user['heure_arrivee']; ?></span>
								</div>								
							</div>
						</a>
						<a href="#" class="flight-book">
							<div class="plane-name">
								<span class="p-flight">Classe :</span>
							</div>
							<div class="desc">
								<div class="left">									
									<span><?PHP echo $user['classe']; ?></span>
								</div>								
							</div>
						</a>
						<a href="#" class="flight-book">
							<div class="plane-name">
								<span class="p-flight">Prix :</span>
							</div>
							<div class="desc">
								<div class="left">									
									<span><?PHP echo $user['prix']; ?> <small>DT</small></span>
								</div>								
							</div>
						</a>
