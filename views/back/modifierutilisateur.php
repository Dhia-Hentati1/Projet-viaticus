    ...
    <form action="" method="POST">
        <table align="center">
            <tr>
                ...
                <td>
                    <input type="text" name="cin" value = "<?php echo $user['cin']; ?>" disabled >
            ...
            <tr>
                ...
                <td>
                    <input type="text" name="nom" maxlength="20" value = "<?php echo $user['nom']; ?>">
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    <input type="text" name="prenom" maxlength="20" value = "<?php echo $user['prenom']; ?>">
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    <input type="email" name="email" pattern=".+@gmail.com|.+@esprit.tn" value = "<?php echo $user['email']; ?>">
                </td>
            </tr>
            <tr>
