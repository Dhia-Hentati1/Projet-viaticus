								...
								<div class="tabulation animate-box">
								  ...
								  <!-- Nav tabs -->
								   <ul class="nav nav-tabs" role="tablist">
									  ...
									  <li role="presentation">
										<a href="#payement" aria-controls="packages" role="tab" data-toggle="tab">Payement</a>
								   </li>
								   </ul>
								   ...
								   <!-- Tab panes -->
									<div class="tab-content">
									 ...
									 <div role="tabpanel" class="tab-pane" id="payement">
                                    ...
                                    <option name="cash" id="cash">Cash</option>
                                    <option name="bank draft" id="bank draft">Bank Draft</option>
                                    <option name="Payment facility" id="Payment facility">Payment facility</option>
                                </select>-->
													<section>
														<label for="class">Type of payements:</label>
														<select class="cs-select cs-skin-border" value="type" name="type" id="type">
															<option value="" disabled selected>Cash</option>
															<option name="cash" id="cash">Cash</option>
															<option name="bank draft" id="bank draft">Bank Draft</option>
															<option name="Payment facility" id="Payment facility">Payement Facility</option>
														</select>
													</section>
												</div>
												...
												<div class="col-xs-12">
													<fieldset>
													<input type="submit" class="btn btn-primary btn-block" value="ajout paiement"/>
